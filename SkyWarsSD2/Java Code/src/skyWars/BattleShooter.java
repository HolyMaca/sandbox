...
public class BattleShooter implements EnemyShips, Fly, Observer, EnterSky {
	
	private int rowNumber;
	private int squareNumber;
	private ImageIcon img = new ImageIcon(getClass().getClassLoader().getResource("battleshooter.png"));
