...
<br>
					<span class = "error"> <?php echo $ckeckbox_err;?></span>
<br>					
					<label>
						<input type="checkbox" id=checkbox name="checkbox"/>By creating an account with us you agree to our<a class="signup" href="signup.php">Terms & Privacy</a>.
					</label>
					<div class="submit">
